...
function initRuntimeSocketService() {
  const hosts = "127.0.0.1,192.168.8.178,172.22.112.1";
  const port = "8090";
  const id = "mp-weixin_OnhrWB";
...
const pages = [
  {
    ...
    style: {
      navigationBarTitleText: "高级信息系统项目管理师"
    }
  },
  {
...
const globalStyle = {
  ...
  navigationBarTitleText: "项目管理师学习",
