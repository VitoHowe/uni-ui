  ...
  setup(__props) {
    ...
    const fetchWrongQuestions = async () => {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pkg-exam/pages/real-exam-wrong/real-exam-wrong.vue:56", "获取错题失败:", error);
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-c11bed4c"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/pkg-exam/pages/real-exam-wrong/real-exam-wrong.js.map
